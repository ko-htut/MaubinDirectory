...
public class List_ATM extends AppCompatActivity {
    final String JSONURL = "http://maubindirectory.000webhostapp.com/ATM/atm.json";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        atm_adapter = new ATM_adapter(this, atm_list, "ATM");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONArray jpagoda_arrs = jos.getJSONArray("atm");

                            for (int i = 0; i < jpagoda_arrs.length(); i++) {
                                JSONObject jatm = jpagoda_arrs.getJSONObject(i);
                                String name = jatm.getString("atm_name");
                                Uri image = Uri.parse(jatm.getString("aimage"));
                            ...
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(List_ATM.this);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        {
                            pd.dismiss();
                            srf.setRefreshing(false);
                            new AlertDialog.Builder(List_ATM.this)
                                    .setTitle("Error!")
